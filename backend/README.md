...
## Project Structure
    ...
    ├── testing_accounting_38760  # Django project configurations
...
1. Clone this repo and `cd testing_accounting_38760`
...
2. Clone this repo and `cd testing_accounting_38760`
